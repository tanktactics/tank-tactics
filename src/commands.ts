...
export const posCommand = new SlashCommandBuilder()
  .setName("pos")
  .setDescription("Get your in-game coordinates");
...
export const walkCommand = new SlashCommandBuilder()
  ...
  .addIntegerOption((option) => option
    .setName("step_count")
    .setDescription("The amount of times to repeat this action")
    .setRequired(false)
  );
...
for (let i = 0; i < 20; i++) {
  createCommand.addUserOption((option) => option
    .setName(`player_${i + 1}`)
...
export const giftCommand = new SlashCommandBuilder()
  ...
  .addUserOption((option) => option
    .setName("receiver")
    .setDescription("The person you want to gift AP")
    .setRequired(true)
  )
  .addIntegerOption((option) => option
    .setName("ap_count")
    .setDescription("The amount of AP you want to donate") 
    .setRequired(true)
  );
